 ...
 */
public class Item_Line implements CanvasItem {
    ...
    @Override
    public void render(RenderingCommands renderingCommands) {
        renderingCommands.drawLine(startPoint, endPoint, lineStroke, color , StrokeEnd);
    }
