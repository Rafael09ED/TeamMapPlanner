package version1.application.client;

import version1.application.MapPlannerGUI;
import version1.application.logic.Line;
import version1.application.logic.MapPlanner;
import version1.networking.client.ConnectionToServerManager;
import version1.networking.interfaces.NetworkSendable;
import version1.networking.interfaces.sendableObjects.NS_ClientInformation;
 ...
 * The ClientManager will connect with a communicator, a console, and eventually a version1.GUI.
 */
	private String host;
